...
@RestController
@RequestMapping("/api/jhipster-peacepact-application-kafka")
public class JhipsterPeacepactApplicationKafkaResource {

    private final Logger log = LoggerFactory.getLogger(JhipsterPeacepactApplicationKafkaResource.class);
    ...
    public JhipsterPeacepactApplicationKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
